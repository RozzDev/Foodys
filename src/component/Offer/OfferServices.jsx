...
import { GiCoffeeCup, GiOpenedFoodCan, GiPizzaSlice, GiCirclingFish } from 'react-icons/gi'
  ...
  return (
    <div className='set'>
        <div className='innerWidth o-wrapper' ref={ref}>
            <motion.div className="o-container innerWidth "
            variants={{
              ...
              transition={{duration: 1}}>
                <div className="o-lists"> 
                    ...
                    <div className="o-words">
                        ...
                        <span className='o-detail'>A small river named Duden flows by their place and supplies it with the necessary regelialia.</span>
                    </div>
                </div>
                <div className="o-lists">
                    <div className="o-icon">
            ...
            <div className="o-container innerWidth ">
                <div className="o-lists"> 
                    <div className="o-icon">
                    <GiCoffeeCup size={44} color='#fff'/>
                    </div>
